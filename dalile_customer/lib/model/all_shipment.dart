...
AllDashbordModel dashbordAllModelFromJson(String str) => AllDashbordModel.fromJson(json.decode(str));

String alldashbordModelToJson(AllDashbordModel data) => json.encode(data.toJson());
...
class AllDashbordModel {
    ...
    factory AllDashbordModel.fromJson(Map<String, dynamic> json) => AllDashbordModel(
...
class AllData {
    ...
    factory AllData.fromJson(Map<String, dynamic> json) => AllData(
        ...
        trackingStatuses: List<TrackingStatus>.from(json["tracking_statuses"].map((x) => TrackingStatus.fromJson(x))),
    );
