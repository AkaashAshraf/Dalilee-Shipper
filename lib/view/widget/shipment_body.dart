                ...
                Padding(
                  ...
                  child: Row(
                    children: [
                      ...
                      _buildRowText(
                          'COP : ${outList?.cop.toString()} ${outList?.ccCurrency} ',
        ...
        child: Column(
          children: [
            ...
            _buildRowDown(text1Color, 12, 'Shipping Cost ',
                '${outList?.shippingPrice.toString()} ${outList?.shippingCurrency} '),
            _buildRowDown(text1Color, 12, 'COD ',
                '${outList?.cod.toString()} ${outList?.cod} '),
            _buildRowDown(primaryColor, 13, 'Total Charges ',
                '${(outList!.shippingPrice! + outList!.cod!).toString()} ${outList?.codCurrency} '),
          ],
        ),
      ),
    );
