...
class ToBeDeliveredData {
  ...
  factory ToBeDeliveredData.fromJson(Map<String, dynamic> json) =>
      ToBeDeliveredData(
        ...
        shipmentsToDelivered: List<ToBeDeliveredShipment>.from(
            json["return_shipments"]
                .map((x) => ToBeDeliveredShipment.fromJson(x))),
...
class ToBeDeliveredShipment {
  ...
  factory ToBeDeliveredShipment.fromJson(Map<String, dynamic> json) =>
      ToBeDeliveredShipment(
        isOpen: false,
