...
const int iosVersionLocal = 16; //26/Sep/2023  force update because of shipper app version
const int androidVersionLocal =  16; //26/Sep/2023  force update because of shipper app version
