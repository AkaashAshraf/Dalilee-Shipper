...
const int iosVersionLocal = 2;
const int androidVersionLocal = 2;

Color primaryColor = Color(isTesEnvironment ? 0xFF05A549 : 0xFF00A1E1);

const whiteColor = Color(0xFFFFFFFF);
const bgColor = Color(0xFFF8F8F8);
const text1Color = Color(0xFF61656A);
Color textBlueColor = Color(isTesEnvironment ? 0xFF05A549 : 0xFF00A1E1);
...
String domain = isTesEnvironment
    ? "https://shaheen-test2.dalilee.om"
    : "https://shaheenom.com"; //
